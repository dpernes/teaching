...
*   este registo cont�m um apontador para uma pilha de contentores
*   e um apontador para o pr�ximo elemento da fila
*/
...
/**
 *  \brief elimina uma fila, libertando toda a mem�ria ocupada
